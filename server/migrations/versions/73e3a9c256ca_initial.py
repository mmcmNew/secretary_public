...
Revision ID: 73e3a9c256ca
Revises: 
Create Date: 2025-08-20 21:33:38.227096
...
def upgrade():
    ...
    sa.Column('IntervalID', sa.String(length=36), nullable=False),
    ...
    sa.Column('ListID', sa.String(length=36), nullable=False),
    sa.Column('user_id', sa.String(length=36), nullable=False),
    ...
    sa.Column('background_count', sa.Integer(), nullable=False),
    sa.PrimaryKeyConstraint('ListID'),
    schema='productivity'
    )
    op.create_table('priorities',
    sa.Column('PriorityID', sa.String(length=36), nullable=False),
    ...
    sa.Column('Order', sa.Integer(), nullable=True),
    sa.Column('Childes', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('Deleted', sa.Boolean(), nullable=True),
    ...
    sa.Column('last_dashboard_id', sa.String(length=36), nullable=True),
    sa.Column('modules', sa.JSON(), nullable=True),
    sa.Column('access_level_id', sa.Integer(), nullable=True),
    sa.Column('is_admin', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['last_dashboard_id'], ['workspace.dashboard.id'], ),
    ...
    sa.Column('is_active', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['dashboard_id'], ['workspace.dashboard.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='workspace'
    )
    ...
    sa.Column('ChildesOrder', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('Color', sa.String(length=20), nullable=True),
    sa.Column('TaskTypeID', sa.String(length=36), nullable=True),
    sa.Column('StatusID', sa.String(length=36), nullable=True),
    sa.Column('PriorityID', sa.String(length=36), nullable=True),
    sa.Column('IntervalID', sa.String(length=36), nullable=True),
    ...
    sa.Column('id', sa.String(length=36), nullable=False),
    sa.Column('user_id', sa.String(length=36), nullable=False),
    sa.Column('TaskID', sa.String(length=36), nullable=True),
    sa.Column('Title', sa.String(length=255), nullable=True),
    sa.Column('Start', sa.DateTime(), nullable=True),
    ...
    sa.Column('TaskID', sa.String(length=36), nullable=False),
    sa.Column('SubtaskID', sa.String(length=36), nullable=False),
...
def downgrade():
    ...
    op.drop_table('timers', schema='workspace')
